...
#
# ZYBO_AXI_Test.tcl: Tcl script for re-creating project 'project_1'
#
# Generated by Vivado on Mon Apr 01 04:09:38 -0500 2019
...
#
# 1. This project restoration tcl script (ZYBO_AXI_Test.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "J:/FPGA/zyboz7/AXI4_tt/rtl/asyn_reset.v"
#    "J:/FPGA/zyboz7/AXI4_tt/rtl/signal_generator.v"
#    "J:/FPGA/zyboz7/AXI4_tt/rtl/design_1_wrapper.v"
#    "J:/FPGA/zyboz7/AXI4_tt/generation/xdc/constr1.xdc"
#    "J:/FPGA/zyboz7/AXI4_tt/simulation/AXI4_Test_Module_simu.v"
#    "J:/FPGA/zyboz7/AXI4_tt/simulation/AXI_4_simu.v"
#    "J:/FPGA/zyboz7/AXI4_tt/simulation/AXI_Controller.v"
#
...
set script_file "ZYBO_AXI_Test.tcl"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../generation/IP"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/../rtl/asyn_reset.v" ]\
 [file normalize "${origin_dir}/../rtl/signal_generator.v" ]\
...
set file "[file normalize "$origin_dir/../generation/xdc/constr1.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "xdc/constr1.xdc"
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../simulation/AXI4_Test_Module_simu.v" ]\
 [file normalize "${origin_dir}/../simulation/AXI_4_simu.v" ]\
 [file normalize "${origin_dir}/../simulation/AXI_Controller.v" ]\
]
...
set obj [get_filesets sim_1]
set_property -name "top" -value "AXI4_Test_Module_simu" -objects $obj
set_property -name "top_lib" -value "xil_defaultlib" -objects $obj


# Adding sources referenced in BDs, if not already added
if { [get_files asyn_reset.v] == "" } {
  import_files -quiet -fileset sources_1 J:/FPGA/zyboz7/AXI4_tt/rtl/asyn_reset.v
}
if { [get_files signal_generator.v] == "" } {
  import_files -quiet -fileset sources_1 J:/FPGA/zyboz7/AXI4_tt/rtl/signal_generator.v
}
...
# signal_generator
  ...
  set_property -dict [ list \
   CONFIG.C_M00_AXI_TARGET_SLAVE_BASE_ADDR {0x30000000} \
 ] $AXI4_Test_0
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_CAN_PERIPHERAL_FREQMHZ {23.809525} \
   ...
   CONFIG.PCW_CAN_PERIPHERAL_DIVISOR0 {42} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#UART 0#UART 0#CAN 1#CAN 1#CAN 0#CAN 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#USB Reset#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} \
   CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#rx#tx#tx#rx#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  connect_bd_intf_net -intf_net AXI4_Test_0_M00_AXI [get_bd_intf_pins AXI4_Test_0/M00_AXI] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net fifo_generator_0_M_AXIS [get_bd_intf_pins AXI4_Test_0/S_AXI_FIFO] [get_bd_intf_pins fifo_generator_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net signal_generator_0_m_axis [get_bd_intf_pins fifo_generator_0/S_AXIS] [get_bd_intf_pins signal_generator_0/m_axis]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins fifo_generator_0/s_aclk] [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins signal_generator_0/clk]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins signal_generator_0/en_gpio]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins AXI4_Test_0/m00_axi_aclk] [get_bd_pins AXI4_Test_0/s_axi_intr_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins fifo_generator_0/m_aclk] [get_bd_pins processing_system7_0/DMA0_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_50M/ext_reset_in] [get_bd_pins signal_generator_0/rst_n]
  ...
  connect_bd_net -net rst_processing_system7_0_50M_peripheral_aresetn [get_bd_pins AXI4_Test_0/m00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins fifo_generator_0/s_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_50M/peripheral_aresetn]
  connect_bd_net -net signal_generator_0_init_axi_txn [get_bd_pins AXI4_Test_0/m00_axi_init_axi_txn] [get_bd_pins signal_generator_0/init_axi_txn]
  connect_bd_net -net signal_generator_0_led [get_bd_ports LED] [get_bd_pins signal_generator_0/led]

  # Create address segments
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces AXI4_Test_0/M00_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
